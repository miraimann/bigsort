...
{
    public class IoServiceMaker
        : IIoServiceMaker
    {
        public IIoService Make(IPool<byte[]> buffersPool) =>
            new IoService(buffersPool);

        private class IoService
            : IIoService
        {
            private readonly IPool<byte[]> _buffersPool;

            public IoService(IPool<byte[]> buffersPool)
            {
